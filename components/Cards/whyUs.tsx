...
const WhyUsCard = ({ title, icon, text }: WhyUsCardType) => {
  return (
    <div className="w-[270px] h-[280px] bg-white hover:bg-secondary/30 pt-4 px-6 flex justify-center rounded-3xl">
      <div className="flex flex-col pt-6 gap-3 ">
        <Image src={icon} width={40} height={40} alt="card-icon" />
        <h3 className="font-bold text-primary pt-4">{title}</h3>
